...
204,733 individual galaxies within a radius of 200 Mpc. HECATE is based on the HyperLEDA catalog and is enriched with additional information from other extragalactic and photometric catalogues. The catalog aims to
...
In order to develop and test the methods presented in this thesis, local universe galactic catalogs of known clusters were also used, like:
